...
export default function servicedetailed({params}) {
  ...
  return (
    <>
            ...
            <div className=' overflow-hidden   bg-gradient-to-tl from-purple-900 to-blue-900 h-[300px] sm:h-[500px] w-full relative'>
              ...
              <div>
                ...
                <div className="flex justify-center max-sm:px-0 py-20 sm:py-40">
                  <h1 className="text-white max-sm:text-3xl px-10 text-6xl font-semibold">
        ...
        <Details2 sern={servicer.n} sername={servicer.name} serimg={servicer.img} serdes={servicer.description}/>    
